<template>
    <div class="flex justify-content-center">
        ...
        <Menu ref="menu" :model="items" popup class="">
            ...
            <template #end>
                <button v-ripple @click="handleSettings" class="relative overflow-hidden w-full border-none bg-transparent flex align-items-start py-2 pl-3 hover:bg-surface-100 dark:hover:bg-surface-800 rounded-none cursor-pointer transition-colors duration-200">
